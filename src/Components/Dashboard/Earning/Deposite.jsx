...
import DepositeTable from "../../Tables/DepositeTable";
...
export default function Deposit() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("/data/depositeData.json");
      ...
      <div className="bg-[#FFFFFF] rounded">
        <div className="flex justify-between ">
          <div className="flex flex-col md:flex-row items-center justify-between w-full gap-5">
            <h1 className="text-3xl font-bold text-secondary-color">Income</h1>
